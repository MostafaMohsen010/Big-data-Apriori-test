...
parser.add_argument('--min_confidence',type=float,default=1)
args=parser.parse_args()

if(args.algorithm == 0):
	get_rules_eff(args.min_support,args.min_confidence)
else:
	compute_rules(args.min_support,args.min_confidence)
